...
| **`ApplyUI-tweaks.ps1`** | Скрипт применения UI-настроек для всех пользователей (включая оффлайн-профили и профиль по умолчанию). Настраивает параметры проводника, панели задач, поиска и другие элементы. | Опциональный |
